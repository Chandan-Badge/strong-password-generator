...
function PasswordGenerator() {
    ...
    return (
            <div className="w-[85vw] sm:w-max px-8 md:px-12 py-8 mt-36 sm:mt-28 flex flex-col items-center bg-[#fff1e6] dark:bg-[#0a1338] rounded-lg drop-shadow-2xl z-10 groupdrop-shadow-[0_0px_30px_rgba(59,130,246,0.6)]">
