        ...
        <footer class="w-full bg-[#02b5af] shadow-sm dark:bg-gray-900 px-12">
            ...
            <div class="w-full max-w-screen-xl mx-auto">
                <div class="sm:flex sm:items-center sm:justify-between">
                    <a href="https://www.chandanchaudhary.in" class="flex items-center py-1.5">
                ...
                <span class="block my-2 text-sm text-gray-200 sm:text-center dark:text-gray-400">© 2025 <a href="https://www.chandanchaudhary.in" class="hover:underline">Chandan Chaudhary</a>. All Rights Reserved.</span>
            </div>
